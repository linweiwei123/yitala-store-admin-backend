...
public class DateUtils {
    ...
    //没横杆的日期格式
    public static final String DATE_FORMAT_T = "yyyyMMdd";
    ...
    // 日期格式化
    private static DateFormat dateFormatT = null;
    // 时间格式化
    ...
    static {
        ...
        dateFormatT = new SimpleDateFormat(DATE_FORMAT_T);
     ...
     * @return
     */
    public static String getDateFormatT(Date date) {
